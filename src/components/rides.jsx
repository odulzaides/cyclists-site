...
const Rides = () => (
    <div id="rides" className="container">
        <h2>Our Rides</h2>
        <p>
            The main starting point for all these rides is at Vons parking lot in Ojai at 9:30 AM*. A map showing this location is <a href="http://ojaicyclists.fpemad.com/maps/Ojai%20%20---%20%20Oak%20View.gif">on this link</a>.  If there is any change to the ride schedule below, all members of the group will be notified by Email.  To get on the email list, or if you have any questions, please contact the Ojai Cyclists.  A map and other interesting data about these rides is shown below after each ride (when available.)
        </p>
        <p>
...
// TODO: Set up the map for the meetup spot
// TODO: Check over Misc Page and add component for pages on sidebar